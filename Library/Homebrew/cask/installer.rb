...
on_request: true)
    ...
    def cask_and_formula_dependencies
      ...
      @cask_and_formula_dependencies = graph.tsort_with_cycles do |cycles|
        ...
        raise CaskCyclicDependencyError.new(@cask.token, Homebrew.to_sentence(cyclic_dependencies))
      end - [@cask]
    end
    ...
    def remove_tabfile
      ...
      ::Utils::Path.rmdir_if_possible(@cask.config_path.parent)
    end
    ...
    def remove_download_sha
      ...
      ::Utils::Path.rmdir_if_possible(@cask.download_sha_path.parent)
    end
    ...
    def purge_backed_up_versioned_files
      ...
      ::Utils::Path.rmdir_if_possible(bmp)
    end
    ...
    def purge_versioned_files
      ...
      if @cask.metadata_versioned_path.directory?
        ...
        ::Utils::Path.rmdir_if_possible(@cask.metadata_versioned_path)
      end
      ::Utils::Path.rmdir_if_possible(@cask.metadata_main_container_path) unless upgrade?

      # toplevel staged distribution
      ::Utils::Path.rmdir_if_possible(@cask.caskroom_path) unless upgrade?
