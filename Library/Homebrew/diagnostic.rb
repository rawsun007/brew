  ...
  module Diagnostic
    ...
    class Checks
      ...
      def check_untrusted_taps
        ...
        generic_trust_message = "#{generic_trust_prefix} #{Homebrew.to_sentence(generic_trust_types)} with:\n" \
      ...
      def check_cask_taps
        ...
        Finding.new("Unable to read from cask #{taps_string}: #{Homebrew.to_sentence(error_tap_paths)}")
      end
